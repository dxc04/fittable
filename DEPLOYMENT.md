...
The `render.yaml` file will automatically create a MySQL database. The database credentials will be automatically injected into your environment variables.
...
**Note**: Sevalla will automatically generate the `APP_KEY` and configure database credentials.
...
1. Verify database is created in Sevalla dashboard
2. Check database environment variables are set correctly
3. Try running migrations manually: `php artisan migrate --force`
...
| DB_* | Auto | Auto-configured by Sevalla |
