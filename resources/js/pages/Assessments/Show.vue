...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: props.assessment.job_posting?.job_title || 'Assessment',
        href: '#',
    },
];
</script>
...
<template>
    <Head
        :title="`Assessment - ${assessment.job_posting?.job_title || 'Job'}`"
    />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="min-h-screen bg-[#1a1d2e]">
                            ...
                            <p class="text-sm text-white/90">
                                ...
                                {{
                                    assessment.job_posting?.company
                                        ? `at ${assessment.job_posting.company}`
                                        : ''
                                }}
                            </p>
                        </div>
            ...
            <div class="container mx-auto px-6 py-8">
                ...
                <div
                    v-if="assessment.application_strategy"
                        ...
                        <ul class="space-y-2 pl-6">
                            <li
                                v-for="(tip, index) in assessment
                                    .application_strategy.resumeOptimization"
                                :key="index"
                        ...
                        <ul class="space-y-2 pl-6">
                            <li
                                v-for="(point, index) in assessment
                                    .application_strategy.coverLetterFocus"
                                :key="index"
                                class="list-disc text-base leading-relaxed text-gray-300"
                            >
                                {{ point }}
                        ...
                        <ul class="space-y-2 pl-6">
                            <li
                                v-for="(strategy, index) in assessment
                                    .application_strategy.howToAddressGaps"
                                :key="index"
                                class="list-disc text-base leading-relaxed text-gray-300"
                            >
                                {{ strategy }}
                ...
                <div
                    v-if="assessment.interview_preparation"
                        ...
                        <ul class="space-y-2 pl-6">
                            <li
                                v-for="(question, index) in assessment
                                    .interview_preparation.likelyQuestions"
                                :key="index"
                                class="list-disc text-base leading-relaxed text-gray-300"
                            >
                                {{ question }}
                        ...
                        <ul class="space-y-2 pl-6">
                            <li
                                v-for="(topic, index) in assessment
                                    .interview_preparation.topicsToStudy"
                                :key="index"
                                class="list-disc text-base leading-relaxed text-gray-300"
                            >
                                {{ topic }}
                        ...
                        <ul class="space-y-2 pl-6">
                            <li
                                v-for="(story, index) in assessment
                                    .interview_preparation.storiesToPrepare"
                                :key="index"
                                class="list-disc text-base leading-relaxed text-gray-300"
                            >
                                {{ story }}
                ...
                <div
                    v-if="assessment.personalized_recommendation"
                    ...
                    <div class="space-y-4 text-white">
                        <div>
                            ...
                            <p class="leading-relaxed">
                                {{
                                    assessment.personalized_recommendation
                                        .shouldApply
                                }}
                            </p>
                        </div>
